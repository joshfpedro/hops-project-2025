...
Our motivating pathosystem represents a multidimensional and challenging problem for modeling, although the problem is not uncommon in agricultural systems with high-value crops [[10]](#Lence2022). A highly dispersible and endemic pathogen has the potential to cause damage to both yield and quality [[21]](#Severns2019). Market factors dictate what cultivars are produced, but market demand conditions dictate quality standards and the penalty for quality defects [[22]](#Hartfield2013). Several strategies are available for disease mitigation: cultural controls that reduce primary inoculum; fungicide applications to reduce the rate of disease development; and strain-specific host resistance.

Given these complexities, what strategies minimize economic losses industry wide?

Our analyses highlight that the conditions in the earliest stages of epidemics are dominant factors shaping economic outcomes. The primary inoculum dose emerged as the most critical factor [[14]](#Severns2022) [[15]](#Estep2014). When the initial probability of inoculum was not severely limiting (i.e., initial probability > 0.0001), the number of fungicide applications in the first month of the epidemic became the most influential factor in controlling economic loss [[16]](#Ojiambo2017). Pathogen strain diversity and the centrality of primary inoculum locations had smaller, yet moderating, effects on economic losses [[17]](#Severns2014). These relative importances were consistent across different market demand scenarios, although the optimal number of fungicide applications increased with more stringent quality standards in lower demand markets [[18]](#Xu1998).

The dramatic effect of relatively small changes in primary inoculum dose on both monocyclic and polycyclic epidemics is well-documented [[19]](#Margosian2009). For polycyclic epidemics, particularly those with leptokurtic dispersal gradients, the potential for and efficiency of containment are highly sensitive to primary inoculum dose, early-stage contact rates, and intervention timing [[21]](#Severns2019). While this is not unexpected, the sensitivity of optimal control strategies to the primary inoculum dose observed in our simulations is striking [[22]](#Hartfield2013). An initial overwintered inoculum probability of 0.0001 resulted in only minor economic damage, even without additional fungicide applications, irrespective of pathogen strain diversity or inoculum location [[23]](#Lofgren2014). This suggests a critical pathogen density is necessary to initiate and sustain epidemics of economic significance [[24]](#Cunniffe2015). Pathogen threshold densities depend on the reproductive ratio and host population homogeneity [[11]](#Plank1963). Notably, we observed minimal economic loss even when the pathogen population consisted entirely of V6-virulent strains capable of infecting all cultivars, effectively creating a homogeneously susceptible host population [[12]](#Cunniffe2015b).

In the hop powdery mildew pathosystem, the estimated frequency of overwintering inoculum from our raw data was [INSERT ACTUAL VALUE HERE, e.g., X.XX% or YYY flag shoots per hectare]. Our simulations demonstrate that a roughly 10-fold reduction in this initial inoculum dose could substantially mitigate economic damage from both fungicide costs and crop losses. Such reductions are achievable through changes in spring cultural practices and planting less susceptible cultivars, provided these are implemented on an area-wide basis. Future research will explore optimal deployment strategies for these changes.

For any given level of market demand and all but the lowest primary inoculum levels in our simulations, the economic impact of epidemics is largely determined by fungicide use intensity. Both under-treatment and over-treatment can lead to suboptimal economic outcomes, with under-treatment generally causing greater losses in our analyses. The overall economic damage increases with higher initial inoculum doses or when the pathogen's virulence structure allows more yards to be infected. Under such increasing pathogen pressure, the optimal fungicide strategy involves more frequent applications (two to three times) in response to disease. The optimal strategy also becomes more narrowly defined as the disease affects more yards, necessitating deviations from baseline fungicide practices.

Counterintuitively, depressed market conditions (lower demand) led to more intensive fungicide use to minimize economic losses. Traditional pest management principles suggest that economic injury levels should align control costs with pest-induced damage, implying lower crop values would reduce fungicide use. Our findings show the opposite can occur when quality standards are tightly linked to price and demand. Under high pathogen pressure, the economic penalty for not treating adequately becomes as severe as over-treating by two to three times the necessary applications.

The simulation results are clearly sensitive to the shape of the damage function. The precise form of this function is uncertain due to vague language in U.S. production contracts. A single, fixed damage function might be suitable where quality standards are explicit and demand-independent. However, we demonstrate that the absence of such clear standards can incentivize increased fungicide use as growers aim to minimize quality defects and the associated risks of crop devaluation or rejection. This highlights the need for clearer quality metrics in agricultural contracts to potentially optimize fungicide use and reduce economic uncertainties for growers.

Further research should also investigate the interplay between fungicide resistance development and long-term economic outcomes, which was not explicitly modeled here. Additionally, incorporating climate change projections could refine predictions, as altered weather patterns may affect pathogen dispersal and development, as well as host susceptibility. The model could also be extended to explore the benefits of coordinated, area-wide management strategies versus individual grower decisions, potentially informing policy interventions.
