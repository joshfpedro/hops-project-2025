...
Our finding that depressed market conditions lead to more intensive fungicide use challenges conventional economic injury level (EIL) concepts in pest management [[25]](#Stern1959). Traditional EIL theory predicts that lower crop values should increase the economic threshold for control action, thereby decreasing pesticide use to match crop damage. On the other hand, incorporating uncertainty or risk aversion into the profit maximizing decision process predicts increased applications of pesticides relative to a risk neutral grower (Feder, 1979) (cite: https://www.sciencedirect.com/science/article/abs/pii/016951509190028J) Furthermore, more stringent quality standards and increased uncertainty of the likelihood of pathogens also tend to increase pesticide use in crop production (Marsh et al. 2000).  Consequently, in the present analysis, as quality standards become more stringent under low-demand scenarios, our simulations show that the individual profit-maximizing strategy requires more intensive fungicide applications, leading individual growers to overuse pesticides in a manner that conflicts with a social optimal.
